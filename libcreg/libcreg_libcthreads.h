...
#if !defined( _LIBCREG_LIBCTHREADS_H )
#define _LIBCREG_LIBCTHREADS_H

#include <common.h>

#if defined( HAVE_MULTI_THREAD_SUPPORT ) && !defined( HAVE_LOCAL_LIBCREG )
#define HAVE_LIBCREG_MULTI_THREAD_SUPPORT
#endif
...
#endif /* defined( HAVE_LIBCREG_MULTI_THREAD_SUPPORT ) */

#endif /* !defined( _LIBCREG_LIBCTHREADS_H ) */
