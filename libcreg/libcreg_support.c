...
#include "libcreg_libclocale.h"
#include "libcreg_libcstring.h"
#include "libcreg_support.h"
...
const char *libcreg_get_version(
             void )
{
	return( (const char *) LIBCREG_VERSION_STRING );
}
...
int libcreg_get_access_flags_read(
     void )
{
	return( (uint8_t) LIBCREG_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libcreg_get_codepage";
...
int libcreg_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libcreg_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libcreg_check_file_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libcreg_check_file_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libcreg_check_file_signature_file_io_handle";
