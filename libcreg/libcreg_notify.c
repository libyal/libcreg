...
{
	static char *function = "libcreg_notify_set_stream";
...
int libcreg_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libcreg_notify_stream_open";
...
int libcreg_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libcreg_notify_stream_close";
