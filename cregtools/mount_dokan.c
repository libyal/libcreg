...
extern mount_handle_t *cregmount_mount_handle;
...
NTSTATUS __stdcall mount_dokan_ZwCreateFile(
                    const wchar_t *path,
                    DOKAN_IO_SECURITY_CONTEXT *security_context CREGTOOLS_ATTRIBUTE_UNUSED,
                    ACCESS_MASK desired_access,
                    ULONG file_attributes CREGTOOLS_ATTRIBUTE_UNUSED,
                    ULONG share_access CREGTOOLS_ATTRIBUTE_UNUSED,
                    ULONG creation_disposition,
                    ULONG creation_options CREGTOOLS_ATTRIBUTE_UNUSED,
                    DOKAN_FILE_INFO *file_info )
{
	libcerror_error_t *error = NULL;
	...
	CREGTOOLS_UNREFERENCED_PARAMETER( security_context )
	CREGTOOLS_UNREFERENCED_PARAMETER( file_attributes )
	CREGTOOLS_UNREFERENCED_PARAMETER( share_access )
	CREGTOOLS_UNREFERENCED_PARAMETER( creation_options )
