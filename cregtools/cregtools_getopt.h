...
#if !defined( _CREGTOOLS_GETOPT_H )
#define _CREGTOOLS_GETOPT_H
...
typedef struct cregtools_option cregtools_option_t;

struct cregtools_option
{
...
#define cregtools_getopt( argument_count, argument_values, options_string ) \
...
void cregtools_getopt_wrapped_fprint(
      FILE *stream,
...
void cregtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const cregtools_option_t *options,
      int number_of_options );

int cregtools_getopt_get_options_string(
     const cregtools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _CREGTOOLS_GETOPT_H ) */
