...
def main( argc, argv ):
	...
	if argc != 1:
		print "Usage: pycreg_test_set_ascii_codepage.py\n"
		return 1
	...
	for codepage in supported_codepages:
		...
		try:
			creg_file.ascii_codepage = codepage
			result = 0
		except:
			result = 1
	...
	for codepage in unsupported_codepages:
		...
		try:
			...
			if exception.message == "pycreg_file_set_ascii_codepage_from_string: unable to determine ASCII codepage.":
				result = 0
		except:
			pass
