...
#if !defined( _CREG_TEST_GETOPT_H )
#define _CREG_TEST_GETOPT_H
...
#define creg_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t creg_test_getopt(
                  int argument_count,
...
#endif /* !defined( _CREG_TEST_GETOPT_H ) */
