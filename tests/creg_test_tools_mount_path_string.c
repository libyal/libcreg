 ...
 */
int creg_test_tools_mount_path_string_copy_hexadecimal_to_integer_32_bit(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int creg_test_tools_mount_path_string_copy_from_key_path(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int creg_test_tools_mount_path_string_copy_to_key_path(
     void )
{
#if defined( HAVE_WIDE_SYSTEM_CHARACTER )
	system_character_t expected_key_path3[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', 0x2028, 't', 0 };
	system_character_t expected_key_path4[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 't', 0 };
...
#else
	system_character_t expected_key_path3[ 8 ] = { LIBCREG_SEPARATOR, 't', 'e', 0xe2, 0x80, 0xa8, 't', 0 };
	system_character_t expected_key_path4[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 't', 0 };
	system_character_t path2[ 9 ]              = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 'x', '0', '3', 't', 0 };
	system_character_t path3[ 15 ]             = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, 'U', '0', '0', '0', '0', '2', '0', '2', '8', 't', 0 };
	system_character_t path4[ 7 ]              = { LIBCPATH_SEPARATOR, 't', 'e', ESCAPE_CHARACTER, ESCAPE_CHARACTER, 't', 0 };
	...
	system_character_t expected_key_path1[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', 's', 't', 0 };
	system_character_t expected_key_path2[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', 0x03, 't', 0 };
	system_character_t expected_key_path5[ 6 ] = { LIBCREG_SEPARATOR, 't', 'e', LIBCREG_SEPARATOR, 't', 0 };
...
#endif
{
	...
	CREG_TEST_RUN(
	 ...
	 creg_test_tools_mount_path_string_copy_hexadecimal_to_integer_32_bit )

	CREG_TEST_RUN(
	 "mount_path_string_copy_from_key_path",
	 creg_test_tools_mount_path_string_copy_from_key_path )

	CREG_TEST_RUN(
	 "mount_path_string_copy_to_key_path",
	 creg_test_tools_mount_path_string_copy_to_key_path )
