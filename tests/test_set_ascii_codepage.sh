...
CREG_TEST_SET_ASCII_CODEPAGE="creg_test_set_ascii_codepage";

if ! test -x ${CREG_TEST_SET_ASCII_CODEPAGE};
then
	CREG_TEST_SET_ASCII_CODEPAGE="creg_test_set_ascii_codepage.exe";
fi

if ! test -x ${CREG_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${CREG_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${CREG_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
