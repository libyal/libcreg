...
PyTypeObject pycreg_value_types_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pycreg.value_types",
	/* tp_basicsize */
	sizeof( pycreg_value_types_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pycreg_value_types_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_init */
	(initproc) pycreg_value_types_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_EXPANDABLE_STRING );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_EXPANDABLE_STRING );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_BINARY_DATA );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_BINARY_DATA );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_INTEGER_32BIT_BIG_ENDIAN );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_INTEGER_32BIT_BIG_ENDIAN );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_SYMBOLIC_LINK );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_SYMBOLIC_LINK );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_MULTI_VALUE_STRING );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_MULTI_VALUE_STRING );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_RESOURCE_LIST );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_RESOURCE_LIST );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_FULL_RESOURCE_DESCRIPTOR );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_FULL_RESOURCE_DESCRIPTOR );
#endif
...
#if PY_MAJOR_VERSION >= 3
	value_object = PyLong_FromLong(
	                LIBCREG_VALUE_TYPE_RESOURCE_REQUIREMENTS_LIST );
#else
	value_object = PyInt_FromLong(
	                LIBCREG_VALUE_TYPE_RESOURCE_REQUIREMENTS_LIST );
#endif
